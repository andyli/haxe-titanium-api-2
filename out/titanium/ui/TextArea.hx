...
extern class TextArea extends Proxy {
...
keyboard is displayed. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var autoLink:Float;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public var autocapitalization:Float;
	...
	/** Determines whether misspelled words input to this text area are automatically corrected. */
...
area. */
	...
	@:require(titanium-android) public var clearOnEdit:Bool;
	...
	@:require(titanium-android) public var hintText:String;
	/** Keyboard type to display when this text area is focused. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public var keyboardType:Float;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public var returnKeyType:Float;
	...
	@:require(titanium-android) public var verticalAlign:[Number, String];
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function getAutocapitalization ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getAutoLink ():Void;
	...
	@:require(titanium-android) public function getClearOnEdit ():Void;
	...
	@:require(titanium-android) public function getHintText ():Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function getKeyboardType ():Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function getReturnKeyType ():Void;
	...
	@:require(titanium-android) public function getVerticalAlign ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function setAutocapitalization (autocapitalization:Float):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setAutoLink (autoLink:Float):Void;
	...
	@:require(titanium-android) public function setClearOnEdit (clearOnEdit:Bool):Void;
	...
	@:require(titanium-android) public function setHintText (hintText:String):Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function setKeyboardType (keyboardType:Float):Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function setReturnKeyType (returnKeyType:Float):Void;
	...
	@:require(titanium-android) public function setVerticalAlign (verticalAlign:[Number, String]):Void;
