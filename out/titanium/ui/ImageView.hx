...
import [array<string>, array<titanium.blob>, array<titanium.filesystem.File>];
...
extern class ImageView extends Proxy {
	...
	@:require(titanium-android) public var canScale:Bool;
...
objects are not supported on Mobile Web. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var images:File>];
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var animating(default,null):Bool;
	/** Indicates whether the animation is paused. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var paused(default,null):Bool;
	/** Local path to the default image to display while loading a remote image. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public var defaultImage:String;
	/** Number of times to repeat the image animation. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var repeatCount:Float;
	/** Number of times to retry decoding the bitmap at a URL. */
	@:require(titanium-android) public var decodeRetries:Float;
...
is ignored when the defaultImage property is set. */
	@:require(titanium-iphone) @:require(titanium-ipad) public var preventDefaultImage:Bool;
	/** Run the animation in reverse. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var reverse:Bool;
...
displays. */
	@:require(titanium-iphone) @:require(titanium-ipad) public var hires:Bool;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getAnimating ():Void;
	...
	@:require(titanium-android) public function getCanScale ():Void;
	...
	@:require(titanium-android) public function getDecodeRetries ():Void;
	/** Gets the value of the defaultImage property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function getDefaultImage ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getHires ():Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getImages ():Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getPaused ():Void;
	/** Gets the value of the preventDefaultImage property. */
	@:require(titanium-iphone) @:require(titanium-ipad) public function getPreventDefaultImage ():Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getRepeatCount ():Void;
	/** Gets the value of the reverse property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getReverse ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function resume ():Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function toBlob ():Void;
	...
	@:require(titanium-android) public function setCanScale (canScale:Bool):Void;
	...
	@:require(titanium-android) public function setDecodeRetries (decodeRetries:Float):Void;
	/** Sets the value of the defaultImage property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) public function setDefaultImage (defaultImage:String):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setHires (hires:Bool):Void;
	/** Sets the value of the image property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setImage (image:File]):Void;
	/** Sets the value of the images property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setImages (images:File>]):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setPreventDefaultImage (preventDefaultImage:Bool):Void;
	/** Sets the value of the repeatCount property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setRepeatCount (repeatCount:Float):Void;
	/** Sets the value of the reverse property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setReverse (reverse:Bool):Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function start ():Void;
