...
extern class MaskedImage extends Proxy {
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var mode:Float;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var tint:String;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var mask:String;
	/** Image drawn as the Foreground image. */
	@:require(titanium-iphone) @:require(titanium-ipad) public var image:String;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getMask ():Void;
	/** Gets the value of the mode property. */
	@:require(titanium-iphone) @:require(titanium-ipad) public function getMode ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getTint ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setImage (image:String):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setMask (mask:String):Void;
	/** Sets the value of the mode property. */
	@:require(titanium-iphone) @:require(titanium-ipad) public function setMode (mode:Float):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setTint (tint:String):Void;
