...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var window:Window;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function close (window:Window, options:Dynamic):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getWindow ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function open (window:Window, options:Dynamic):Void;
