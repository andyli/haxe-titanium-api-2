...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	public function getHinttextid ():Void;
...
layout pass after they have been updated. */
	...
	public function setShowCancel (showCancel:Bool, ?animated:Dynamic):Void;
