...
extern class Clipboard {
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public static function clearData (type:String):Void;
	/** Clear the text portion of the clipboard. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public static function clearText ():Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public static function getText ():Void;
	/** Get the data on the clipboard from the portion which contains data of the given mime-type. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public static function getData (type:String):Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public static function hasText ():Void;
	/** Return true if there is any content of the given mime-type on the clipboard. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public static function hasData (type:String):Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public static function setData (type:String, data:Dynamic):Void;
	/** Set the text on the clipboard. This will overwrite the current contents of the clipboard. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public static function setText (text:String):Void;
