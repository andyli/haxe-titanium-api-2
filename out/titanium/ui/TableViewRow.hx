...
One of: 'composite', 'vertical', or 'horizontal'. */
	...
	public function getRightImage ():Void;
	/** Gets the value of the selectedBackgroundColor property. */
	public function getSelectedBackgroundColor ():Void;
	/** Gets the value of the selectedBackgroundImage property. */
	public function getSelectedBackgroundImage ():Void;
	/** Gets the value of the selectedColor property. */
	public function getSelectedColor ():Void;
	/** Gets the value of the selectionStyle property. */
	public function getSelectionStyle ():Void;
