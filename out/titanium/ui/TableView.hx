...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	public function getAllowsSelection ():Void;
	/** Gets the value of the allowsSelectionDuringEditing property. */
	public function getAllowsSelectionDuringEditing ():Void;
	...
	public function getEditing ():Void;
	/** Gets the value of the filterAttribute property. */
	public function getFilterAttribute ():Void;
	/** Gets the value of the filterCaseInsensitive property. */
	public function getFilterCaseInsensitive ():Void;
