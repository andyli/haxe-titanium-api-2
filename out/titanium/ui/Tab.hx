...
typedef Tab = {
	...
	public var window:titanium.ui.Window;
...
One of: 'composite', 'vertical', or 'horizontal'. */
	...
	public function close (window:titanium.ui.Window, ?options:Dynamic):Void;
	...
	/** Opens a new window. */
	public function open (window:titanium.ui.Window, options:Dynamic):Void;
...
layout pass after they have been updated. */
	...
	public function setWindow (window:titanium.ui.Window):Void;
