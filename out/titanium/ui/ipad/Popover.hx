...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-ipad) public var leftNavButton:Dynamic;
	...
	@:require(titanium-ipad) public function getArrowDirection ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-ipad) public function setPassthroughViews (passthroughViews:Array<Object>):Void;
	...
	@:require(titanium-ipad) public function setArrowDirection (arrowDirection:Float):Void;
	...
	@:require(titanium-ipad) public function setLeftNavButton (leftNavButton:Dynamic):Void;
