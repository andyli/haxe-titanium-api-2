...
extern class DocumentViewer extends Proxy {
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-ipad) public function setUrl (url:String):Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-ipad) public function show (animated:Bool, view:Dynamic):Void;
