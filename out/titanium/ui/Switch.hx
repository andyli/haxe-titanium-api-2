...
extern class Switch extends Proxy {
	...
	@:require(titanium-android) @:require(titanium-mobileweb) public var color:String;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var value:Bool;
	...
	@:require(titanium-android) @:require(titanium-mobileweb) public var font:Font;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-android) public var style:Float;
	...
	@:require(titanium-android) @:require(titanium-mobileweb) public var textAlign:[String, Number];
	/** Text to display when a toggle button-style switch is toggled off. */
	@:require(titanium-android) @:require(titanium-mobileweb) public var titleOn:String;
	/** Text to display when a toggle button-style switch is toggled on. */
	@:require(titanium-android) @:require(titanium-mobileweb) public var titleOff:String;
...
TEXT_VERTICAL_ALIGNMENT_TOP. */
	...
	@:require(titanium-android) @:require(titanium-mobileweb) public function getColor ():Void;
	...
	@:require(titanium-android) @:require(titanium-mobileweb) public function getFont ():Void;
	...
	@:require(titanium-android) public function getStyle ():Void;
	/** Gets the value of the textAlign property. */
	@:require(titanium-android) @:require(titanium-mobileweb) public function getTextAlign ():Void;
	/** Gets the value of the title property. */
	@:require(titanium-android) public function getTitle ():Void;
	/** Gets the value of the titleOff property. */
	@:require(titanium-android) @:require(titanium-mobileweb) public function getTitleOff ():Void;
	/** Gets the value of the titleOn property. */
	@:require(titanium-android) @:require(titanium-mobileweb) public function getTitleOn ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-android) @:require(titanium-mobileweb) public function setColor (color:String):Void;
	...
	@:require(titanium-android) @:require(titanium-mobileweb) public function setFont (font:Font):Void;
	...
	@:require(titanium-android) public function setStyle (style:Float):Void;
	/** Sets the value of the textAlign property. */
	@:require(titanium-android) @:require(titanium-mobileweb) public function setTextAlign (textAlign:[String, Number]):Void;
	/** Sets the value of the title property. */
	@:require(titanium-android) public function setTitle (title:String):Void;
	/** Sets the value of the titleOff property. */
	@:require(titanium-android) @:require(titanium-mobileweb) public function setTitleOff (titleOff:String):Void;
	/** Sets the value of the titleOn property. */
	@:require(titanium-android) @:require(titanium-mobileweb) public function setTitleOn (titleOn:String):Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setValue (value:Bool):Void;
