...
extern class PickerRow extends Proxy {
	...
	@:require(titanium-mobileweb) public var color:String;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var fontSize:Float;
	/** Font to use for the item text. */
	@:require(titanium-mobileweb) public var font:Font;
	/** Item text. */
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-mobileweb) public function getColor ():Void;
	/** Gets the value of the focusable property. */
	@:require(titanium-android) public function getFocusable ():Void;
	/** Gets the value of the font property. */
	@:require(titanium-mobileweb) public function getFont ():Void;
	/** Gets the value of the fontSize property. */
	@:require(titanium-iphone) @:require(titanium-ipad) public function getFontSize ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-mobileweb) public function setColor (color:String):Void;
	/** Sets the value of the focusable property. */
	@:require(titanium-android) public function setFocusable (focusable:Bool):Void;
	/** Sets the value of the font property. */
	@:require(titanium-mobileweb) public function setFont (font:Font):Void;
	/** Sets the value of the fontSize property. */
	@:require(titanium-iphone) @:require(titanium-ipad) public function setFontSize (fontSize:Float):Void;
