...
extern class ProgressBar extends Proxy {
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var value:Float;
...
layout pass after they have been updated. */
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setValue (value:Float):Void;
