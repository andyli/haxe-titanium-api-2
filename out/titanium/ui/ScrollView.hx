...
extern class ScrollView extends Proxy {
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var horizontalBounce:Bool;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var showHorizontalScrollIndicator:Bool;
	/** Determines whether the vertical scroll indicator is visible. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var showVerticalScrollIndicator:Bool;
	/** Determines whether vertical scroll bounce of the scrollable region is enabled. */
	@:require(titanium-iphone) @:require(titanium-ipad) public var verticalBounce:Bool;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var contentHeight:[Number, String];
	/** Limits the direction of the scrollable region, overriding the deduced setting. Set to 
horizontal or vertical. */
	@:require(titanium-android) public var scrollType:String;
	/** Maximum scaling factor of the scrollable region and its content. */
	@:require(titanium-iphone) @:require(titanium-ipad) public var maxZoomScale:Float;
	/** Minimum scaling factor of the scrollable region and its content. */
	@:require(titanium-iphone) @:require(titanium-ipad) public var minZoomScale:Float;
	...
	/** Scaling factor of the scrollable region and its content. */
	@:require(titanium-iphone) @:require(titanium-ipad) public var zoomScale:Float;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var contentWidth:[Number, String];
	/** X and Y coordinates to which to reposition the top-left point of the scrollable region. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var contentOffset:Dynamic;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getContentHeight ():Void;
	/** Gets the value of the contentOffset property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getContentOffset ():Void;
	/** Gets the value of the contentWidth property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getContentWidth ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getHorizontalBounce ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getMaxZoomScale ():Void;
	/** Gets the value of the minZoomScale property. */
	@:require(titanium-iphone) @:require(titanium-ipad) public function getMinZoomScale ():Void;
	...
	@:require(titanium-android) public function getScrollType ():Void;
	/** Gets the value of the showHorizontalScrollIndicator property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getShowHorizontalScrollIndicator ():Void;
	/** Gets the value of the showVerticalScrollIndicator property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function getShowVerticalScrollIndicator ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getVerticalBounce ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getZoomScale ():Void;
	/** Hides this view. */
	...
	/** Moves the bottom of the scrollable region into the viewable area. */
	@:require(titanium-android) public function scrollToBottom ():Void;
	/** Moves the specified coordinate of the scrollable region into the viewable area. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function scrollTo (x:Float, y:Float):Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setContentHeight (contentHeight:[Number, String]):Void;
	/** Sets the value of the contentOffset property. */
	@:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setContentOffset (contentOffset:Dynamic, ?animated:ContentOffsetOption):Void;
	/** Sets the value of the contentWidth property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setContentWidth (contentWidth:[Number, String]):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setHorizontalBounce (horizontalBounce:Bool):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setMaxZoomScale (maxZoomScale:Float):Void;
	/** Sets the value of the minZoomScale property. */
	@:require(titanium-iphone) @:require(titanium-ipad) public function setMinZoomScale (minZoomScale:Float):Void;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setShowHorizontalScrollIndicator (showHorizontalScrollIndicator:Bool):Void;
	/** Sets the value of the showVerticalScrollIndicator property. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function setShowVerticalScrollIndicator (showVerticalScrollIndicator:Bool):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setVerticalBounce (verticalBounce:Bool):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setZoomScale (zoomScale:Float):Void;
