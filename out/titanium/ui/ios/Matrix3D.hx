...
typedef Matrix3D = {
	...
	public function multiply (t2:titanium.ui.ios.Matrix3D):titanium.ui.ios.Matrix3D;
	...
	public function rotate (angle:Float, x:Float, y:Float, z:Float):titanium.ui.ios.Matrix3D;
	/** Returns a matrix constructed by scaling an existing matrix. */
	public function scale (sx:Float, sy:Float, sz:Float):titanium.ui.ios.Matrix3D;
	/** Returns a matrix constructed by translating an existing matrix. */
	public function translate (tx:Float, ty:Float, tz:Float):titanium.ui.ios.Matrix3D;
