...
extern class AdView extends Proxy {
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var adSize:String;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function cancelAction ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getAdSize ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setAdSize (adSize:String):Void;
