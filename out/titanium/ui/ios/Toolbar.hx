...
extern class Toolbar extends Proxy {
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var items:View>;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var borderBottom:Bool;
	/** If true, a border is drawn on the top of the toolbar. */
	@:require(titanium-iphone) @:require(titanium-ipad) public var borderTop:Bool;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getBorderBottom ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getBorderTop ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getItems ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setBorderBottom (borderBottom:Bool):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setBorderTop (borderTop:Bool):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setItems (items:View>):Void;
