...
extern class TabbedBar extends Proxy {
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var labels:[Array<String>, Array<BarItemType>];
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var index:Float;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getLabels ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setIndex (index:Float):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setLabels (labels:[Array<String>, Array<BarItemType>]):Void;
