...
import [array<string>, array<titanium.blob>, array<titanium.filesystem.File>, Array<CoverFlowImageType>];
import [string, titanium.blob, titanium.filesystem.File, CoverFlowImageType];
...
extern class CoverFlowView extends Proxy {
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var images:File>, Array<CoverFlowImageType>];
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public var selected:Float;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setImage (index:Float, image:File, CoverFlowImageType]):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getImages ():Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function getSelected ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setImages (images:File>, Array<CoverFlowImageType>]):Void;
	...
	@:require(titanium-iphone) @:require(titanium-ipad) public function setSelected (selected:Float):Void;
