...
extern class PickerColumn extends Proxy {
	...
	/** Rows of this column. */
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var rows(default,null):PickerRow>;
...
One of: 'absolute', 'vertical', or 'horizontal'. */
	...
	@:require(titanium-mobileweb) public var selectedRow:PickerRow;
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function addRow (row:PickerRow):Void;
	...
	@:require(titanium-mobileweb) public function getSelectedRow ():Void;
...
layout pass after they have been updated. */
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public function removeRow (row:PickerRow):Void;
	...
	@:require(titanium-mobileweb) public function setSelectedRow (selectedRow:PickerRow):Void;
