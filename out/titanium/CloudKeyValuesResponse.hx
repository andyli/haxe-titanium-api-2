...
extern class CloudKeyValuesResponse extends Proxy {
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var keyvalues:Array<Object>;
	/** Error code, if any. */
