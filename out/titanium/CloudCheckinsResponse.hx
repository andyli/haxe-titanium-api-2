...
extern class CloudCheckinsResponse extends Proxy {
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var checkins:Array<Object>;
	/** Error code, if any. */
