...
typedef NamedNodeMap = {
	...
	public function setNamedItemNS (node:titanium.xml.Node):titanium.xml.Node;
	...
	public function setNamedItem (node:titanium.xml.Node):titanium.xml.Node;
	...
	public function removeNamedItemNS (namespaceURI:String, localName:String):titanium.xml.Node;
	...
	public function removeNamedItem (name:String):titanium.xml.Node;
	...
	public function getNamedItemNS (namespaceURI:String, localName:String):titanium.xml.Node;
	/** Retrieves a node specified by name. */
	public function getNamedItem (name:String):titanium.xml.Node;
	/** Retrieves the node at the specified index of the map. Note that NamedNodeMaps are not ordered. */
	public function item (index:Float):titanium.xml.Node;
