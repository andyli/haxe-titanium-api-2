...
extern class Chats {
	...
	public static function getChatGroups (?parameters:Dynamic, _callback:CloudChatGroupsResponse->Dynamic):Void;
	/** Retrieve a list of chat messages with sorting and pagination. */
	public static function query (parameters:Dynamic, _callback:CloudChatsResponse->Dynamic):Void;
	/** Send a chat message to another user or a group of users. */
	public static function create (parameters:Dynamic, _callback:CloudChatsResponse->Dynamic):Void;
