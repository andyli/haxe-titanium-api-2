...
mode. */
	...
	public static function read (sourceStream:IOStream, buffer:Buffer, ?offset:Float, ?length:Float, resultsCallback:ReadCallbackArgs->Dynamic):Void;
	/** Asynchronously writes data from a buffer to an IOStream. */
	public static function write (outputStream:IOStream, buffer:Buffer, ?offset:Float, ?length:Float, resultsCallback:WriteCallbackArgs->Dynamic):Void;
	...
	public static function readAll (sourceStream:IOStream, ?buffer:Buffer, ?resultsCallback:ReadCallbackArgs->Dynamic):Void;
	/** Reads data from input stream and passes it to a handler method. */
	public static function pump (inputStream:IOStream, handler:PumpCallbackArgs->Dynamic, maxChunkSize:Float, ?isAsync:Bool):Void;
	/** Removes the specified callback as an event listener for the named event. */
	public static function removeEventListener (name:String, _callback:Dynamic->Dynamic):Void;
	/** Writes all data from an input stream to an output stream. */
	public static function writeStream (inputStream:IOStream, outputStream:IOStream, maxChunkSize:Float, ?resultsCallback:WriteStreamCallbackArgs->Dynamic):Void;
