...
the Menu button.  */
	...
	public function setOnCreateOptionsMenu (onCreateOptionsMenu:Dynamic->Dynamic):Void;
	/** Sets the value of the onPrepareOptionsMenu property. */
	public function setOnPrepareOptionsMenu (onPrepareOptionsMenu:Dynamic->Dynamic):Void;
	...
	public function startActivityForResult (intent:Intent, _callback:ActivityResult->Dynamic):Void;
