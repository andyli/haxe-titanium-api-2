...
extern class CloudPhotoCollectionsPhotosResponse extends Proxy {
	...
	@:require(titanium-android) @:require(titanium-iphone) @:require(titanium-ipad) @:require(titanium-mobileweb) public var photos:Array<Object>;
	/** Error code, if any. */
